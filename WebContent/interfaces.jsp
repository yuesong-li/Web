	...
	<div class="container">
		<div class="fake_img">
			...
			<form name="turnLightInOff" method="post" action="ServerComms">
				<input name="button" type="submit"
					id="lightOffButton" value="lightIn:off"
		...
		<div class="fake_img">
			...
			<form name="turnLightOutOn" method="post" action="ServerComms">
				<input name="button" type="submit"
					id="lightOnButton2" value="lightIn:on"
					style="height: 20px; width: 40px">
			</form>
			<form name="turnLightOutOff" method="post" action="ServerComms">
				<input name="button" type="submit"
					id="lightOffButton2" value="lightOut:off"
					style="height: 20px; width: 40px">
			</form>
		</div>
		...
		<div class="fake_img">
			...
			<form name="turnFanOn" method="post" action="ServerComms">
				<input name="button" type="submit" id="fanOnButton"
					value="fan:on" style="height: 20px; width: 40px">
			</form>
			<form name="turnFanOff" method="post" action="ServerComms">
				<input name="button" type="submit" id="fanOffButton"
					value="fan:off" style="height: 20px; width: 40px">
			</form>
		</div>
		...
		<div class="fake_img">
			...
			<form name="turnRoomHeaterOn" method="post" action="ServerComms">
				<input name="button" type="submit"
					id="heaterRoomOnButton" value="heaterRoom:on"
					style="height: 20px; width: 40px">
			</form>
			<form name="turnRoomHeaterOff" method="post" action="ServerComms">
				<input name="button" type="submit"
					id="heaterRoomOffButton" value="heaterLoft:off"
					style="height: 20px; width: 40px">
			</form>
		</div>
